package com.israelsantiago.bookstore.orders.web.exception;

import com.israelsantiago.bookstore.orders.domain.InvalidOrderException;
import com.israelsantiago.bookstore.orders.domain.OrderNotFoundException;
import java.net.URI;
...
class GlobalExceptionHandler extends ResponseEntityExceptionHandler {
    ...
    ProblemDetail handleUnauthorizedException(InvalidOrderException e) {
        ProblemDetail problemDetail = ProblemDetail.forStatusAndDetail(HttpStatus.UNAUTHORIZED, e.getMessage());
        problemDetail.setTitle("Order Not Found");
        problemDetail.setType(BAD_REQUEST_TYPE);
        problemDetail.setProperty("service", SERVICE_NAME);
        problemDetail.setProperty("error_category", "Unauthorized");
        problemDetail.setProperty("timestamp", Instant.now());
        return problemDetail;
    }
}
